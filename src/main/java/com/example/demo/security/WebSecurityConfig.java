    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(AntPathRequestMatcher.antMatcher("/api/auth/signin")).permitAll()
                        .requestMatchers(AntPathRequestMatcher.antMatcher("/api/auth/signup")).permitAll()
                        .requestMatchers(AntPathRequestMatcher.antMatcher("/api/bikes/all")).permitAll()
                ...
                //         .ignoringRequestMatchers(AntPathRequestMatcher.antMatcher("/api/bikes/all/**"))
                //         );
